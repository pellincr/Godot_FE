...
signal device_changed(device: String, device_index: int) #What to do on device change
signal keyboard_input_changed(action: String, input: InputEvent) #Change the control of the keyboard
signal joypad_input_changed(action: String, input: InputEvent) #Change the control of the joypad
