...
const COMBAT_EXCHANGE = "COMBAT_EXCHANGE"
...
enum PLAYER_STATE
{
	...
	UNIT_SUPPORT_ACTION,
	#Demolish
	UNIT_DEMOLISH_ACTION_INVENTORY,
	UNIT_DEMOLISH_ACTION_TARGETTING,
	UNIT_DEMOLISH_ACTION,
	#Shove
	...
	#Prep
	PREP_UNIT_SELECT,
	PREP_UNIT_SELECT_HOVER,
	PREP_UNIT_DETAILS_SCREEN,
	PREP_MENU
}
...
enum TRIGGERS {
	NONE, # ALWAYS ACTIVE
	ON_COMBAT_EXCHANGE_INITIATE,
	ON_COMBAT_EXCHANGE_DEFEND,
	ON_COMBAT_EXCHANGE_ATTACK_HIT,
	ON_COMBAT_EXCHANGE_ATTACK_CRITICAL_HIT,
	ON_COMBAT_EXCHANGE_PROFILE_TRIANGLE_ADVANTAGE,
	ON_COMBAT_EXCHANGE_PROFILE_TRIANGLE_DISADVANTAGE,
	ON_COMBAT_EXCHANGE_ATTACK_HIT_RECIEVED,
	ON_COMBAT_EXCHANGE_DODGE,
	ON_COMBAT_EXCHANGE_DEFEAT_ENEMY,
	ON_COMBAT_EXCHANGE_CRITICAL_HIT,
	ON_UNIT_BLOCK_BREAK,
	ON_UNIT_TAKE_DAMAGE,
	ON_UNIT_ACTION_WAIT,
	ON_UNIT_ACTION_SWAP,
	ON_UNIT_HP_FULL,
	ON_UNIT_HP_BELOW_HALF,
	ON_FRIENDLY_TURN_START,
	ON_FRIENDLY_TURN_END,
	ON_ENEMY_TURN_START,
	ON_ENEMY_TURN_END
}
