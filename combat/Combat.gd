...
#
	...
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("bladehand", iventory_array, "Bandit", 8,12, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(15,3))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["killer_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Bandit", 8,12, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(16,4))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_sword"])
