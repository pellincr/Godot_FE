...
func _ready():
	...
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["archer"], iventory_array, "Boko", 5,10, false),0), Vector2i(7,15))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_sword"])
	#iventory_array.insert(1, ItemDatabase.items["sabre"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["fencer"], iventory_array, "Christian", 6,12, false), 0), Vector2i(7,16))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["enchanted_shotel"])
	#iventory_array.insert(1, ItemDatabase.items["iron_dagger"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["thief"], iventory_array, "Craig", 3,9, false), 0), Vector2i(8,16))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_axe"])
	#iventory_array.insert(1, ItemDatabase.items["silver_axe"])
	#iventory_array.insert(1, ItemDatabase.items["hand_axe"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_axe"], iventory_array, "Devin", 4,11, false), 0), Vector2i(8,14))
	#iventory_array.clear()
	...
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["legionary_lance"], iventory_array, "Justin", 8,15),0), Vector2i(8,15))
	#iventory_array.clear()
	#iventory_array.append(ItemDatabase.items["wind_blade"])
	#iventory_array.append(ItemDatabase.items["fire_spell"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_magic"], iventory_array, "Lynn", 4,11),0), Vector2i(9,15))
	#iventory_array.clear()
	#iventory_array.append(ItemDatabase.items["brass_knuckles"])
	#iventory_array.append(ItemDatabase.items["devil_knuckles"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["martial_artist"], iventory_array, "Avon", 4,11),0), Vector2i(9,16))
...
#
	...
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["gargoyle"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(9,2))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_lance"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["gargoyle"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(17,11))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_bow"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_archer"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(6,2))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["dark_pulse"])
	#iventory_array.insert(0, ItemDatabase.items["sharp_claws"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["drake"], iventory_array, "Braumulus", 12,2, false), 1, Constants.UNIT_AI_TYPE.DEFEND_POINT, false, true), Vector2i(12,2))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["halberd"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_lance"], iventory_array, "Fiend", 6,12, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(2,4))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["steel_lance"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_lance"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(3,3))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["javelin"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_lance"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(15,8))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["fire_spell"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["imp"], iventory_array, "Fiend", 9,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(3,14))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["dark_pulse"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["imp"], iventory_array, "Fiend", 7,12, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(13,3))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["fiend_fire"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["imp"], iventory_array, "Fiend", 9,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(7,7))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_sword"], iventory_array, "Fiend", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(14,8))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["silver_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_sword"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(6,9))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["dark_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_sword"], iventory_array, "Fiend", 9,9, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(7,9))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_sword"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(15,3))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["killer_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["bonewalker_sword"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(16,4))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["mercenary"], iventory_array, "Gemni's Guard", 6,10, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(10,23))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_axe"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_axe"], iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(8,23))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_lance"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_lance"], iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(15,21))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["steel_lance"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_lance"], iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(0,20))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["fire_spell"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_magic"], iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(14,21))
	#iventory_array.clear()
	#iventory_array.insert(2, ItemDatabase.items["bolting"])
	#iventory_array.insert(0, ItemDatabase.items["fiend_fire"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["cavalier_magic"], iventory_array, "Gemni", 12,15, true), 1, Constants.UNIT_AI_TYPE.DEFEND_POINT, false, true), Vector2i(10,24))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["hand_axe"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["kobold_axe"], iventory_array, "Fiend", 5,11, true), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(16,7))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["iron_axe"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["kobold_axe"], iventory_array, "Fiend", 5,11, true), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(1,11))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["sharp_claws"])
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["zombie"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(2,3))
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["zombie"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(16,3))
	#add_combatant(create_combatant_unit(Unit.create_generic_unit(UnitTypeDatabase.unit_types["zombie"], iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(15,11))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["hand_axe"])
