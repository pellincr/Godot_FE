...
#
	...
	add_combatant(create_combatant_unit(Unit.create_generic_unit("lance_cavalier", iventory_array, "Bandit", 3,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(9,2))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["iron_lance"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("pikeman", iventory_array, "Bandit", 3,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(17,11))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["iron_bow"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("archer", iventory_array, "Bandit", 3,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(6,2))
	#iventory_array.clear()
	...
	add_combatant(create_combatant_unit(Unit.create_generic_unit("pikeman", iventory_array, "Bandit", 3,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(3,3))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["javelin"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("lance_cavalier", iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(15,8))
	#iventory_array.clear()
	...
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(14,8))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["silver_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("bladehand", iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(6,9))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["dark_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Bandit", 9,9, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(7,9))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("bladehand", iventory_array, "Bandit", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(15,3))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["killer_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Bandit", 8,13, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(16,4))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Gemni's Guard", 6,10, false), 1, Constants.UNIT_AI_TYPE.ATTACK_IN_RANGE), Vector2i(10,23))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["iron_axe"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("axe_armor", iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(8,23))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["iron_lance"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("lance_armor", iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(15,21))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_lance"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("lance_cavalier", iventory_array, "Bandit", 6,8, false), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(0,20))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["fire_spell"])
	...
	add_combatant(create_combatant_unit(Unit.create_generic_unit("fighter", iventory_array, "Fiend", 5,11, true), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(16,7))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["iron_axe"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("fighter", iventory_array, "Fiend", 5,11, true), 1, Constants.UNIT_AI_TYPE.DEFAULT), Vector2i(1,11))
	#iventory_array.clear()
	#iventory_array.insert(0, ItemDatabase.items["sharp_claws"])
