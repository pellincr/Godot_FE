...
#
	...
	add_combatant(create_combatant_unit(Unit.create_generic_unit("bladehand", iventory_array, "Fiend", 8,13, false), 1, Constants.UNIT_AI_TYPE.DEFEND_POINT), Vector2i(6,9))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["dark_sword"])
	add_combatant(create_combatant_unit(Unit.create_generic_unit("sellsword", iventory_array, "Bandit", 9,9, false), 1, Constants.UNIT_AI_TYPE.DEFEND_POINT), Vector2i(7,9))
	iventory_array.clear()
	iventory_array.insert(0, ItemDatabase.items["steel_sword"])
