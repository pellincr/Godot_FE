...
func _ready():
	...
	if verify_save_path(save_path_1):
		set_save_button_text(save_button_1,"Slot 1 - LOAD")
		set_delete_visibility(delete_button_1,true)
	if verify_save_path(save_path_2):
		set_save_button_text(save_button_2,"Slot 2 - LOAD")
		set_delete_visibility(delete_button_2,true)
	if verify_save_path(save_path_3):
		set_save_button_text(save_button_3,"Slot 3 - LOAD")
		set_delete_visibility(delete_button_3,true)
...
func _on_save_slot_1_delete_button_pressed():
	_on_delete_save_button_pressed(save_path_1,save_button_1,delete_button_1)
...
func _on_save_slot_2_delete_button_pressed():
	_on_delete_save_button_pressed(save_path_2,save_button_2,delete_button_2)
