...
func update():
	...
	$BackPanel/MarginContainer/HBoxContainer/InventoryMarginContainer/UnitInfoInventoryContainer/MarginContainer/UnitInfoContainer/MoveContainer/MoveValue.text = str(unit.unit.stats.movement)
	#HP Panel
	$BackPanel/MarginContainer/HBoxContainer/HealthMarginContainer/Health/HPValueContainer/CurrentHP.text = str(unit.unit.hp)
	$BackPanel/MarginContainer/HBoxContainer/HealthMarginContainer/Health/HPValueContainer/MaxHP.text = str(unit.unit.stats.hp)
	#Stat Grid
	...
	$BackPanel/MarginContainer/HBoxContainer/StatsGridMargin/CenterContainer/StatsGrid/Res/Value.text = str(unit.unit.stats.resistance)
	$BackPanel/MarginContainer/HBoxContainer/StatsGridMargin/CenterContainer/StatsGrid/Def/Value.text = str(unit.unit.stats.defense)
	update_background()
