...
@onready var check_box : CheckBox = $Panel/MarginContainer/HBoxContainer/CheckBox

@onready var unit_name_label = $Panel/MarginContainer/HBoxContainer/HBoxContainer/UnitNameLabel
@onready var unit_icon = $Panel/MarginContainer/HBoxContainer/HBoxContainer/UnitIcon
...
func _ready():
	if unit!= null:
		update_by_unit()
		unit_icon.self_modulate = "828282"
	if selected:
		check_box.button_pressed = true
		unit_icon.self_modulate = "FFFFFF"
