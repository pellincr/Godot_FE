...
@onready var left_icon = $LowerContainer/PanelContainer/HBoxContainer/LeftIcon
@onready var right_icon = $LowerContainer/PanelContainer2/HBoxContainer/RightIcon
...
func swap_header_icons():
	var temp = left_icon.texture
	left_icon.texture = right_icon.texture
	right_icon.texture = temp
