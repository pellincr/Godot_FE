...
func update_by_unit():
	...
	set_value_label(damage_100_place_label, (unit.attack/100)%10)
	set_value_label(damage_10_place_label, (unit.attack/10)%10)
	set_value_label(damage_1_place_label, (unit.attack/1)%10)
	
	set_value_label(hit_100_place_label, (unit.hit/100)%10)
	set_value_label(hit_10_place_label, (unit.hit/10)%10)
	set_value_label(hit_1_place_label, (unit.hit/1)%10)
	
	set_value_label(critical_100_place_label, (unit.critical_hit/100)%10)
	set_value_label(critical_10_place_label, (unit.critical_hit/10)%10)
	set_value_label(critical_1_place_label, (unit.critical_hit/1)%10)
	
	set_value_label(avoid_100_place_label, (unit.avoid/100)%10)
