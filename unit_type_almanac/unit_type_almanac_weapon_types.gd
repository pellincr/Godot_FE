...
var weapon_type : ItemConstants.WEAPON_TYPE
...
func set_icon_visibility():
	if weapon_type == ItemConstants.WEAPON_TYPE.SWORD:
		sword_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.AXE:
		axe_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.LANCE:
		lance_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.SHIELD:
		shield_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.DAGGER:
		dagger_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.FIST:
		fist_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.BOW:
		bow_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.BANNER:
		banner_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.STAFF:
		staff_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.NATURE:
		nature_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.LIGHT:
		light_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.DARK:
		dark_icon.visible = true
	if weapon_type == ItemConstants.WEAPON_TYPE.ANIMAL:
